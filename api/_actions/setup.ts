// Vercel-compatible version of setup action
...
} from "../_lib/instrumented-client-vercel.js";
import { annotations } from "../../server/annotations.js";

const ACTION = "setup";

export async function setupActionVercel() {
  // -----------------------------------------------------------------------
  ...
  await emitAccounts(accountStore.toPublic());
}